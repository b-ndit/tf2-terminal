...
fn specta_builder() -> Builder<tauri::Wry> {
    Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::settings::set_steam_session,
            commands::settings::has_steam_session,
            commands::settings::clear_steam_session,
            ...
            commands::trades::send_trade_offer,
            commands::trades::accept_trade_offer,
            commands::trades::decline_trade_offer,
            commands::trades::get_public_inventory,
